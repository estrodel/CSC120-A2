...
def main():
    ...
    computer1.itemID = shop.buy(computer1)
    print("Done.\n")
    ...
    print("Refurbishing Item ID:",computer1.itemID, ", updating OS to", new_OS)
    ...
    # Now, let's sell it!
    print("Selling Item ID:", computer1.itemID)
    shop.sell(computer1.itemID)
